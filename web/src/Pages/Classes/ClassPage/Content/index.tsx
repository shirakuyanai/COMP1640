            ...
            >
              ...
              <CardContent className="p-4 md:p-6 pt-0 md:pt-0">
                ...
                <div className="flex items-center gap-2 mb-3 text-xs text-gray-500">
                  <div className="bg-gray-200 rounded-full w-5 h-5 flex items-center justify-center overflow-hidden">
                    <span className="uppercase font-medium text-gray-600">
                      {item.uploadedBy.username.charAt(0)}
                    </span>
                  </div>
                  <span>
                    Uploaded by <span className="font-medium">{item.uploadedBy.username}</span>
                  </span>
                </div>
