	...
	return (
		<div className="p-8 space-y-8 bg-slate-50 min-h-screen">
			...
			<div className="bg-white rounded-xl shadow-sm p-6 border border-slate-100">
				{currentUser?.role === 'staff' && viewingUserId !== currentUser.id ? (
					<div className="flex justify-between items-center">
						<div>
							<h1 className="text-3xl font-bold text-slate-800">Student Dashboard View</h1>
							<p className="text-slate-500 mt-1">Viewing student's dashboard and activities</p>
						</div>
						<Button
					...
					<>
						...
						<p className="text-slate-500">Here's a summary of your interactions with your personal tutor</p>
					</>
				)}
			</div>
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
				...
				/>
				<StatCard
					icon={<FaGraduationCap className="text-amber-600 h-6 w-6" />}
					title="Upcoming"
			...
			<Card className="border-none shadow-md">
				<CardHeader className="border-b border-slate-100 bg-white rounded-t-xl">
					<CardTitle className="text-slate-800">My Classes & Tutors</CardTitle>
				</CardHeader>
								...
								<div key={classItem.id} className="p-6 bg-slate-50 rounded-xl border border-slate-100 hover:border-blue-100 hover:bg-blue-50 transition-colors">
									<div className="flex justify-between items-start">
										<div>
											...
											<p className="text-sm text-slate-500 mt-1">Tutor: {classItem.tutorUsername}</p>
										</div>
